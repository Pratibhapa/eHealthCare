...
<html lang="en">
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(right, #141414, #00c6ff);
}
...
.text-primary {
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%; padding-bottom: 20px;font-family:'IBM Plex Sans', sans-serif;"> Welcome Dr.&nbsp<?php echo $_SESSION['dname'] ?>  </h3>
    <div class="row">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    $con=mysqli_connect("localhost","root","","myhmsdb");
                    global $con;
                      // $query="SELECT * FROM appointmenttb WHERE doctor='Ganesh'";
